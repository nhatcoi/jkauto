...
export const assertionKeywords: KeywordDef[] = [
  {
    ...
    executors: { web: assertTextFn, mobile: assertTextFn, desktop: assertTextFn },
  },
  {
  ...
  },
  {
    ...
    hasExpected: false,
    objectPlaceholder: 'Selector',
    executors: { web: assertVisibleFn, mobile: assertVisibleFn, desktop: assertVisibleFn },
  },
  {
    name: 'assert-hidden',
    label: 'Assert Hidden',
    ...
    hasExpected: false,
    objectPlaceholder: 'Selector',
    executors: { web: assertHiddenFn, mobile: assertHiddenFn, desktop: assertHiddenFn },
  },
  {
  ...
  },
  {
    ...
    hasExpected: false,
    objectPlaceholder: 'Selector',
    executors: { web: getTextFn, mobile: getTextFn, desktop: getTextFn },
  },
]
